...
function FieldInput({ name, label, value, onChange, required, hint, placeholder, type = "text", textarea }: FieldInputProps) {
  return (
    <div className="field">
      <label htmlFor={name}>
        {label} {required && <b>*</b>}
...
function ThankYouView({ onReset }) {
  return (
    <section className="thank-you">
      ...
      <button className="button btn button-primary" type="button" onClick={onReset} style={{ marginTop: "42px" }}>
        Start another brief
      </button>
    </section>
  );
...
export default function ClientOnboarding() {
  ...
  return (
    <>
      ...
      <div className="app-shell client-root">
        {/* ── SIDEBAR ── */}
        <aside className="sidebar">
          <div>
            <button className="brand-link btn" type="button" onClick={resetForm} aria-label="Go to form">
